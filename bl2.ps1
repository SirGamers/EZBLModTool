function Get-DirectoryPath {
    param (
        [string]$promptMessage = "Press enter if your Borderlands 2 folder is stored at C:\Program Files (x86)\Steam\steamapps\common\Borderlands 2, otherwise type in the path to BL2 and press enter",
        [string]$defaultPath = "C:\Program Files (x86)\Steam\steamapps\common\Borderlands 2"
    )
